...
@javax.annotation.processing.Generated(value = "org.yamcs.protoc.ServiceGenerator", date = "2023-11-18T19:00:35.925761Z")
@SuppressWarnings("unchecked")
public abstract class AbstractSessionsApi<T> implements Api<T> {
     ...
     * </pre>
     */
    public abstract void listSessions(T ctx, Empty request, Observer<ListSessionsResponse> observer);

    @Override
    public final ServiceDescriptor getDescriptorForType() {
        return SessionsServiceProto.getDescriptor().getServices().get(0);
    }
    ...
    public final void callMethod(MethodDescriptor method, T ctx, Message request, Observer<Message> future) {
        ...
        switch (method.getIndex()) {
        case 0:
            listSessions(ctx, (Empty) request, (Observer<ListSessionsResponse>)(Object) future);
            return;
        default:
            throw new IllegalStateException();
        }
