...
@javax.annotation.processing.Generated(value = "org.yamcs.protoc.ServiceGenerator", date = "2023-11-18T19:00:35.919954Z")
@SuppressWarnings("unchecked")
public abstract class AbstractParameterValuesApi<T> implements Api<T> {
    ...
    public final ServiceDescriptor getDescriptorForType() {
        return ParameterValuesServiceProto.getDescriptor().getServices().get(0);
    }
    ...
    public final Message getRequestPrototype(MethodDescriptor method) {
        ...
        case 0:
            return LoadParameterValuesRequest.getDefaultInstance();
        default:
    ...
    public final Message getResponsePrototype(MethodDescriptor method) {
        ...
        switch (method.getIndex()) {
        case 0:
            return LoadParameterValuesResponse.getDefaultInstance();
        default:
            throw new IllegalStateException();
        }
    }
    ...
    public final Observer<Message> callMethod(MethodDescriptor method, T ctx, Observer<Message> future) {
        ...
        switch (method.getIndex()) {
        case 0:
            return (Observer<Message>)(Object) loadParameterValues(ctx, (Observer<LoadParameterValuesResponse>)(Object) future);
        default:
            throw new IllegalStateException();
        }
    }
